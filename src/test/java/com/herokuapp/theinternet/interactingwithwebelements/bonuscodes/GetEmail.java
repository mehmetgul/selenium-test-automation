...
/**
 * Us this things:
 * //        String link = GetEmail.email("<email>","<password>","<search_text");
 * //        Driver.getDriver().get(link);
 */

public class GetEmail {

    public static String email(String email, String password, String searchSubjectText) throws Exception {
        String linkUrl = "";
        Properties props = new Properties();
        props.setProperty("mail.store.protocol", "imaps");
//            props.setProperty("mail.imaps.host", "mail.richardrosellc.com");
