...
public class IframeTestClassEnhanced {
    public static void main(String[] args) throws InterruptedException {
        WebDriver driver = new ChromeDriver();
        driver.get("https://google.com/recaptcha/api2/demo");

        List<Integer> iAmNotARobotList= findElementsInFrames(driver,By.xpath("//div[@class='recaptcha-checkbox-border']"));
        ...
        Thread.sleep(1000);
        List<Integer> verifyButtonList =  findElementsInFrames(driver,By.xpath("//button[@id='recaptcha-verify-button']"));
